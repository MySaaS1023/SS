    ...
    <>
      ...
      <section id="services" className="pt-10 pb-8 sm:pt-14 sm:pb-10 lg:pt-16 lg:pb-10">
        <PageContainer>
          ...
          <div className="mt-8 rounded-[1.8rem] border border-[#CBBDB6] bg-[#FAF6F4] px-6 py-6 shadow-[0_18px_40px_rgba(52,44,44,0.09)]">
      ...
      <section className="pt-2 pb-10 sm:pt-4 sm:pb-14 lg:pt-4 lg:pb-16">
        <PageContainer>
          <div className="rounded-[1.8rem] border border-[#CBBDB6] bg-[#FAF6F4] px-6 py-6 shadow-[0_18px_40px_rgba(52,44,44,0.09)] sm:px-8 sm:py-8">
