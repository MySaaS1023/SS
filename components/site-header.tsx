      ...
      <PageContainer className="relative flex items-center justify-between gap-3 py-2 md:gap-5 md:py-2.5">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <button
            ...
            className="glass-panel inline-flex h-9 w-9 items-center justify-center rounded-xl border border-[rgba(139,92,246,0.22)] text-white shadow-[0_0_24px_rgba(59,130,246,0.08)] transition hover:border-[rgba(59,130,246,0.28)] md:hidden"
          >
